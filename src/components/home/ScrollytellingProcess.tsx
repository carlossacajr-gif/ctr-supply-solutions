...
export function ScrollytellingProcess() {
    ...
    return (
        <section id="how-it-works" className="bg-slate-50 dark:bg-slate-900 py-24 sm:py-32" ref={containerRef}>
            <Container>
                ...
                <div className="relative max-w-5xl mx-auto">
                    ...
                    {steps.map((step, index) => (
                        <div key={index} className="flex flex-col lg:flex-row gap-8 mb-24 lg:mb-32 min-h-[40vh] items-center last:mb-0 relative">
                            {/* Step Number Node */}
                            <div className="flex absolute left-0 lg:left-4 w-8 h-8 rounded-full bg-white dark:bg-slate-950 border-2 border-ctr-blue items-center justify-center z-10 shadow-glass">
                            ...
                            <div className="flex-1 lg:w-1/2 order-2 lg:order-1 pl-12 lg:pl-20">
                                <FadeIn direction="right" delay={0.2}>
                                    ...
                                    <h3 className="text-2xl font-bold text-ctr-slate dark:text-white mb-4">{step.title}</h3>
                            ...
                            <div className="flex-1 lg:w-1/2 h-64 lg:h-80 w-full relative lg:sticky lg:top-32 order-1 lg:order-2 mb-8 lg:mb-0 pl-14 lg:pl-0">
                                <FadeIn direction="left" delay={0.1} className="h-full w-full">
                                    <div className="relative h-full w-full rounded-2xl overflow-hidden shadow-glass-lg border border-slate-200/60 dark:border-slate-700/60">
                                        <Image
                                            src={step.image}
                                            alt={step.alt}
                                            fill
